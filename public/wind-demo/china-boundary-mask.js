/**
 * 中国边界 MultiPolygon 点内判断，用于风场粒子裁剪。
 */
(function (global) {
  ...
  function normalizePolygons(geojson) {
    ...
    if (!geometry?.coordinates?.length) {
      throw new Error('china-boundary.geojson 缺少 geometry');
    }
  ...
  function createChinaBoundaryMask(geojson) {
  ...
  global.createChinaBoundaryMask = createChinaBoundaryMask;
